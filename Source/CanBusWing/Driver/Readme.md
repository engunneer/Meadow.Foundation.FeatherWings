...
The **GPSWing** library is included in the **Meadow.Foundation.FeatherWings.GPSWing** nuget package and is designed for the [Wilderness Labs](www.wildernesslabs.co) Meadow .NET IoT platform.
